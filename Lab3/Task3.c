...
/* Obtaining the Highest possible time delay interval with a suitable prescalar.*/

#include <avr/io.h>

void delay_timer0(){

    TCNT0 = 0; // set initial value of timer register to 0

    TCCR0A = 0x00;  // set timer0 to normal mode.
    TCCR0B = 0x05;  //(set the prescale 1/1024 to see the blink clearly..)
